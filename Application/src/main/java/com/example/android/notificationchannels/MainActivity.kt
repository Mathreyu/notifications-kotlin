...
class MainActivity : Activity() {
    ...
    private fun sendNotification(id: Int) {
        when (id) {
            NOTIFICATION_FOLLOW -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                mNotificationHelper.notify(id, mNotificationHelper.getNotificationFollowerLowAPI(
                        getString(R.string.follower_title_notification),
                        getString(R.string.follower_added_notification_body,
                                mNotificationHelper.randomName))!!)
            }

            NOTIFICATION_UNFOLLOW -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                mNotificationHelper.notify(id, mNotificationHelper.getNotificationFollower(
                        getString(R.string.follower_title_notification),
            ...
            NOTIFICATION_DM_FRIEND -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                mNotificationHelper.notify(id, mNotificationHelper.getNotificationDM(
                        getString(R.string.direct_message_title_notification),
                        getString(R.string.dm_friend_notification_body,
                                mNotificationHelper.randomName)))
            } else {
                mNotificationHelper.notify(id, mNotificationHelper.getNotificationDMLowAPI(
                        getString(R.string.direct_message_title_notification),
                        getString(R.string.dm_friend_notification_body,
                                mNotificationHelper.randomName))!!)
            ...
            NOTIFICATION_DM_COWORKER -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                mNotificationHelper.notify(id, mNotificationHelper.getNotificationDM(
                        getString(R.string.direct_message_title_notification),
